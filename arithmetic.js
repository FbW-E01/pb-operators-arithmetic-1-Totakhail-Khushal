...
//6 Declare another variable "monkeyfights" with value 20. Add monkeys and bananas, then multiply the result by monkeysfights.Store the result in variable "resultTwo".Print "resultTwo" to the console.
